    ...
    <div class="table-container">
      <el-table ref="adminTable" :data="list" style="width: 100%;" v-loading="listLoading" border>
        ...
        <el-table-column label="操作" width="250" align="center">
          <template slot-scope="scope">
            <el-button size="mini" type="info" @click="handleSelectRole(scope.$index, scope.row)">分配角色
            </el-button>
    ...
    <el-dialog :title="isEdit?'编辑用户':'添加用户'" :visible.sync="dialogVisible" width="40%"
      ...
      <el-form :model="admin" :rules="rules" ref="adminForm" label-width="150px" size="small">
        ...
        <el-form-item label="用户姓名：" prop="nickName">
          <el-input v-model="admin.nickName" placeholder="请输入姓名"></el-input>
        </el-form-item>
        ...
        <el-form-item label="用户备注：">
          <el-input v-model="admin.note" type="textarea" :rows="5" placeholder="请输入备注"></el-input>
        </el-form-item>
      ...
      <span slot="footer" class="dialog-footer">
        <el-button @click="cancledialog('adminForm')" size="small">取 消</el-button>
