...
<!--              </el-button>-->
    ...
    <el-dialog :title="isEdit?'编辑角色':'添加角色'" :visible.sync="dialogVisible" width="40%"
      @close="cancledialog('roleForm')">
      <el-form :model="role" :rules="rules" ref="roleForm" label-width="150px" size="small">
        <el-form-item label="角色名称：" prop="name">
          <el-input v-model="role.name" placeholder="请输入角色名称"></el-input>
        </el-form-item>
        <el-form-item label="角色描述：">
          <el-input v-model="role.description" type="textarea" :rows="5" placeholder="请输入角色描述"></el-input>
        </el-form-item>
      ...
      <span slot="footer" class="dialog-footer">
        <el-button @click="cancledialog('roleForm')" size="small">取 消</el-button>
